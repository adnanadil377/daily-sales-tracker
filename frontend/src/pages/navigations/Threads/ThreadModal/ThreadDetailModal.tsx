...
const ThreadDetailModal: React.FC<Props> = ({ report, onClose, onApprove, onReject }) => {
  ...
  return (
    <div className="fixed inset-0 z-500 bg-gradient-to-b from-blue-50/10 via-purple-300/5 to-blue-600/10 backdrop-blur-[2px] flex items-center justify-center animate-fadeIn">
      <div className="relative bg-white/90 rounded-xl shadow-2xl shadow-red-500/20 max-w-md w-full p-6 transition-transform animate-slideFadeIn animate-slideUp">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-blue-900">Thread #{report.Salesid} </h2>
        ...
        <div className="space-y-2 text-sm mb-4">
          ...
          <div className="flex justify-between">
            ...
            <span>QAR {report.totalSales.toFixed(2)}</span>
          </div>
          <div className="flex justify-between">
            <span>Final Value</span>
            <span>QAR {report.finalValue.toFixed(2)}</span>
          </div>
          <div className="flex justify-between">
        ...
        <div className="mt-4">
          <h3 className="font-semibold text-blue-800 mb-2">Product Breakdown:</h3>
        ...
        <div className="flex justify-between gap-2 mt-6">
          ...
          <button
            ...
            className="flex-1 bg-green-100 text-green-700 font-semibold py-2 rounded-lg hover:bg-green-200 transition"
          >
            Approve
          </button>
        </div>
