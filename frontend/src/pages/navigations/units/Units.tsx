  ...
  return (
    <PageContainer title="Retail Partner">
      <div className="p-4">
        ...
        <h2 className="text-lg font-extrabold text-neutral-800 tracking-tight border-l-2 border-green-500 bg-gradient-to-r from-green-500/10 to-transparent rounded-lg py-2 pl-4">
          All Partners {" "}
        <span className="">
